...
import com.yxc.location.map.location.event.LocationEvent;
import com.yxc.location.map.location.service.LocalLocationService;
import com.yxc.location.map.location.service.LocationService;
import com.yxc.location.map.location.util.LocationComputeUtil;
import com.yxc.location.map.location.util.LocationConstants;
import com.yxc.location.map.location.util.Utils;
    ...
    protected void saveRecord(List<RecordLocation> list) {
        if (list != null && list.size() > 0) {
            ...
            Record record = Record.createRecord(recordType, Double.toString(distance),
                    ...
                    firstLocation.locationStr, lastLocation.locationStr, dateStr);
